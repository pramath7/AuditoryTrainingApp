...
public class QuestionActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    private void checkAnswer(int option_selected){
        answered = true;
        if (option_list[option_selected].equals(currentQuestion.getAnswer())) {
